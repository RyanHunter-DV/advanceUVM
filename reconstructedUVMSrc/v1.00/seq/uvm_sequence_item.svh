...
class uvm_sequence_item extends uvm_transaction;
  ...
  protected  uvm_sequencer_base m_sequencer;
	...
	// @RyanH, will change name to parentSeq
  ...
  // @uvm-ieee 1800.2-2017 auto 14.1.2.2
	...
	// @RyanH, set member: sequence_info
	// set sequencer to parent_sequence's sequencer if input sequencer is null
	// set parent sequence
	function void set_item_context(
		uvm_sequence_base  parent_seq,
		uvm_sequencer_base sequencer = null
	);
		// @RyanH, flag, m_use_sequence_info
		set_use_sequence_info(1);

		// @RyanH, set to member: m_parent_sequence
